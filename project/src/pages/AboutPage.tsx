    ...
    <div className="min-h-screen relative pt-24 pb-12">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-16 animate-fadeIn">
          <h1 className="text-5xl font-bold text-gradient mb-6">About DiagnoDose AI</h1>
          ...
          <div className="md:flex">
            ...
            <div className="md:w-1/2 p-8 md:p-12">
              ...
              <p className="text-indigo-700 mb-6 leading-relaxed">
                At DiagnoDose AI, we're committed to enhancing patient safety and treatment efficacy through 
        ...
        <div className="mb-16 animate-fadeInUp delay-400">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              {
                name: "Manish Kumar Raut",
                role: "Front-end Developer",
                image: "https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80"
              },
              {
                name: "Alex",
                role: "Pharmaceutical Specialist and ML",
                image: "https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80"
              },
              {
                name: "Rohan Singh",
        ...
        <div className="glass-effect rounded-2xl p-12 text-center mb-16 animate-fadeInUp delay-500 relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <p className="text-indigo-700 text-lg max-w-3xl mx-auto mb-8">
              Join healthcare providers worldwide who are using DiagnoDose AI to improve patient outcomes through personalized drug dosing.
            </p>
            <Link 
              to="/predict" 
